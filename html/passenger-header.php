        ...
        <div class="container-fluid">
          <nav class="navbar navbar-expand-lg header-nav">
            ...
            <div class="main-menu-wrapper">
              ...
              <li <?php echo ($currentPage == 'passenger-dashboard.php') ? 'class="active"' : ''; ?>><a href="passenger-dashboard.php">Home</a></li>
                ...
                <li class="has-submenu <?php echo (in_array($currentPage, ['passenger-view-nearby.php', 'passenger-reserve-history.php'])) ? 'active' : ''; ?>">
                    ...
                    <ul class="submenu">
                        <li <?php echo ($currentPage == 'passenger-view-nearby.php') ? 'class="active"' : ''; ?>><a href="passenger-view-nearby.php">Near By Drivers</a></li>
                        <li <?php echo ($currentPage == 'passenger-reserve-history.php') ? 'class="active"' : ''; ?>><a href="passenger-reserve-history.php">Reserve History</a></li>
                    </ul>
                </li>
                <li class="login-link">
            ...
            <ul class="nav header-navbar-rht">
              <li class="nav-item">
                <a class="nav-link header-login" href="passenger-profile.php"
