<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from dreamsrent.dreamstechnologies.com/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jan 2024 07:33:31 GMT -->
  <head>
    <meta charset="utf-8" />
    <meta
      name="viewport"
            ...
            <div class="row align-items-center">
              <div class="col-lg-6" data-aos="fade-down">
                <p class="explore-text">
                  <span><i class="fa-solid fa-thumbs-up me-2"></i></span>100%
                  Trusted car rental platform in the World
                </p>
                <h1>
                  Find Your Best <br />
                ...
                <div class="col-lg-4 col-md-6 col-12" data-aos="fade-down">
                  <div class="listing-item">
                    ...
                    <div class="listing-content">
                      ...
                      <div class="listing-location-details">
                        <div class="listing-price">
                          <span><i class="feather-map-pin"></i></span>Dallas,
                          USA
                        </div>
                        <div class="listing-price">
                          <h6>$30 <span>/ Day</span></h6>
              ...
              <div class="price-card flex-fill">
                ...
                <div class="price-details">
                  <ul>
                    ...
                    <li class="price-check">
                      <span><i class="fa-regular fa-circle-check"></i></span>Min
                      1 month, extend anytime
                    </li>
                    <li class="price-check">
                    ...
                    <li class="price-uncheck">
                      <span><i class="fa-regular fa-circle-xmark"></i></span>Min
                      1 month, extend anytime
                    </li>
                  </ul>
                  <a href="login.html" class="btn viewdetails-btn"
                    >Request a demo</a
                  >
                </div>
              </div>
            ...
            <div class="col-lg-3 d-flex col-md-6 col-12" data-aos="fade-down">
              <div class="price-card flex-fill active">
                ...
                <div class="price-details">
                  ...
                  <a href="login.html" class="btn viewdetails-btn btn-popular"
                    >Request a demo</a
                  >
                </div>
              </div>
  ...
  <!-- Mirrored from dreamsrent.dreamstechnologies.com/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jan 2024 07:34:04 GMT -->
</html>
